...
LOCK TABLES `teststudents` WRITE;
/*!40000 ALTER TABLE `teststudents` DISABLE KEYS */;
INSERT INTO `teststudents` VALUES (6,'Vignesh',NULL);
/*!40000 ALTER TABLE `teststudents` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-07-29 14:54:27
