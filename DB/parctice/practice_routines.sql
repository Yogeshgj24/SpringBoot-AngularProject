...
/*!50001 VIEW `studentview` AS select `student`.`Student_id` AS `Student_id`,`student`.`Name` AS `Name`,`student`.`Hobby_Id` AS `Hobby_id` from `student` */;
...
-- Dump completed on 2023-07-29 14:54:31
